...
export function selectCharts(settings: GameSettings): {
  ...
  if (settings.deckCount === 6) {
    if (settings.hitSoft17) {
      return { uncommon: d6H17DasUncommon, chart: d6H17DasChart };
    } else {
      return { uncommon: d6S17DasUncommon, chart: d6S17DasChart };
    }
  }
